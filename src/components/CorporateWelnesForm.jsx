    ...
    if (window.grecaptcha) {
      window.grecaptcha.ready(() => {
        Promise.resolve(
          ...
          .then(async (token) => {
            await sendMail({ ...formData, type: 'corporate_wellness' });
      ...
      sendMail({ ...formData, type: 'corporate_wellness' })
        .then(() => {
          toast.success('Your details have been submitted. An expert will contact you soon!');
          setFormData({
            name: '',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-[Arima] text-2xl font-bold text-orange-500">Corporate Plan</h2>
        <p className="mb-4 text-sm text-gray-600">Request a Demo</p>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="font-[Inter] text-xs font-semibold text-gray-700">Full Name *</label>
            <input
              required
              type="text"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              required
              placeholder="Briefly describe your requirements or health goals"
          ...
          >
            {isSubmitting ? <Loader /> : 'Request Demo'}
          </button>
        </form>
      </div>
    </div>
