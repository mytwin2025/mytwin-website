...
export default function HealthScorePopup() {
  ...
  const renderLeadCapture = () => (
    <div className="animate-in fade-in zoom-in-95 relative flex h-full flex-col bg-[#f2f3f7] duration-500 overflow-y-auto">
      <button
        onClick={closeWizard}
      ...
      <div className="z-10 flex flex-1 flex-col bg-[#f2f3f7] px-7 py-8 md:rounded-2xl md:px-10 md:py-10">
        ...
        <div className="mb-auto">
          <div className="relative mb-1 overflow-hidden rounded-2xl">
            ...
            <div className="absolute inset-0 flex flex-col items-start justify-start pb-4">
              <h2 className="text-[2.4rem] font-black leading-[1.8rem] tracking-tight text-gray-900">Get your</h2>
              <h2 className="text-[2.4rem] font-black leading-[3.8rem] tracking-tight text-[#F36B21]">Health</h2>
              <h2 className="text-[2.4rem] font-black leading-[1.8rem] tracking-tight text-[#F36B21]">Risk Score</h2>
              {/* ECG divider */}
              <div className="mt-3 flex w-3/6 items-center justify-start ">
                <div className="h-[1.5px] w-1/2 bg-[#F36B21]/50"></div>
                <svg viewBox="0 0 90 28" className="h-6 w-20 text-[#F36B21]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="mb-7 space-y-4">
            <div className="flex items-start gap-4">
              ...
              <p className="text-[12px] font-medium leading-snug text-gray-700 text-left">
                Continuous health monitoring,<br />personalised guidance and <br />experts clinical protocols <br /> tailored to your profile straight <br /> to your inbox.
              </p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <p className="text-[12px] font-medium leading-snug text-gray-700 text-left">
                No spam, full data privacy<br />and security.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-[0_6px_32px_rgba(0,0,0,0.10)]">
            <div className="space-y-5">
              <div className="flex items-center gap-4">
                <div className="text-[#F36B21] mt-6">
                  <Phone size={26} strokeWidth={2} />
                </div>
                <div className="flex-1">
                  <label className="mb-1 block text-[13px] text-gray-500 text-left">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-gray-50 py-2 px-4 text-gray-900 outline-none placeholder:text-gray-400 focus:border-[#F36B21] focus:bg-white focus:ring-1 focus:ring-[#F36B21]"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <label className="mb-1 block text-[13px] font-semibold text-gray-500 text-left">
                    Your email ID
                  </label>
                  <input
                    type="email"
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-2 text-[11px] font-medium text-gray-500">
          <div className="flex items-center gap-2">
            ...
            <span className="leading-tight">Bank-level<br />Security</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="rounded-md border border-gray-300 p-1.5">
              <ShieldCheck size={14} className="text-gray-500" />
            </div>
            <span className="leading-tight">Your Data.<br />Always Yours.</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="rounded-md border border-gray-300 p-1.5">
              <User size={14} className="text-gray-500" />
            </div>
            <span className="leading-tight">We Never Share<br />Your Information</span>
          </div>
        </div>
        </div>
    </div>
  ...
  const renderScoreResult = () => {
    ...
    return (
      <div className="animate-in slide-in-from-bottom-4 relative flex h-full flex-col bg-white duration-500 overflow-y-auto">
        <button
          onClick={closeWizard}
        ...
        <div className="custom-scrollbar flex flex-1 flex-col items-center overflow-y-auto p-6 md:p-8 pt-14">
          <h2 className="mb-8 text-2xl font-bold text-gray-900">MyTwin Health Risk Score</h2>

          {/* Semi-circle Gauge */}
          <div className="relative mb-6 flex h-36 w-64 flex-col items-center justify-end overflow-hidden">
            <svg viewBox="0 0 200 100" className="absolute top-0 h-full w-full">
              <defs>
            ...
            <div className="absolute bottom-2 flex flex-col items-center">
              <div className="text-5xl font-black leading-none text-gray-900">{score}</div>
              <div className="text-lg font-semibold text-gray-500">/100</div>
            </div>
          </div>
          ...
          <div className="mb-8 w-full rounded-2xl border border-orange-100 bg-orange-50/50 p-6 shadow-sm">
            ...
            <ul className="space-y-3">
              {priorities.map((item, i) => (
                <li
                  key={i}
                  className="flex items-center gap-3 border-b border-orange-100/50 pb-1 font-medium text-[12px] text-gray-800 last:border-0 last:pb-0 text-left"
                >
          ...
          <div className="mb-8 flex gap-4 rounded-xl border border-gray-200 bg-gray-50 p-5">
            ...
            <p className="text-[13px] font-medium leading-relaxed text-gray-600 text-left">{riskDesc}</p>
          </div>
  ...
  const renderThankYou = () => (
    <div className="animate-in zoom-in-95 relative flex h-full flex-col bg-white duration-500 overflow-y-auto overflow-x-hidden">
      <button
        onClick={closeWizard}
      ...
      <div className="custom-scrollbar flex-1 p-6 md:p-8">
        {/* Header Section */}
        ...
        <div className="mb-6 text-center text-[17px] font-bold text-gray-900 leading-snug">
          Your details have been<br />
          received <span className="text-[#15803d]">successfully.</span>
        </div>

        {/* Human Body section */}
        <div className="relative mb-8 flex justify-center">
          <img src={thankHumanImg} alt="Human Assessment" className="w-[85%] max-w-[280px] object-contain" />
        </div>
        ...
        <div className="mb-8 px-2">
          ...
          <ul className="flex flex-col">
            {[
              ...
              <li key={i} className="flex items-center justify-start text-left gap-2 border-b border-orange-50 py-1 text-[11px] font-semibold text-gray-700 last:border-b-0">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <div className="flex w-full justify-center gap-3">
            <a 
              ...
              className="flex flex-1 max-w-[160px] items-center justify-center gap-2 rounded-xl bg-black px-3 py-2 text-white"
            >
              <img src={Media.header.playstore} alt="Google Play" className="h-6 w-6 object-contain" />
        ...
        <div className="mb-6 flex justify-between rounded-xl bg-[#fafafa] p-3 text-[10px] font-bold">
          <div className="flex flex-1 flex-col items-center gap-1.5 text-center text-[#166534]">
            ...
            <div className="leading-tight">100%<br />Privacy & Security</div>
          </div>
          <div className="flex flex-1 flex-col items-center gap-1.5 border-l border-r border-gray-200 text-center text-[#F36B21]">
            ...
            <div className="leading-tight">Your Data Is<br />Always Yours</div>
          </div>
          <div className="flex flex-1 flex-col items-center gap-1.5 text-center text-[#6b21a8]">
            <div className="rounded-full bg-[#f3e8ff] p-2">
              <Lock size={16} />
            </div>
            <div className="leading-tight">We Never Share<br />Your Data</div>
          </div>
        </div>
        ...
        <div className="flex flex-col overflow-hidden rounded-2xl border border-orange-100 bg-[#fff7ed]">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="text-[14px] font-bold leading-tight text-[#F36B21]">
              Need Help From<br />Our Experts?
            </div>
          </div>
          <div className="flex border-t border-orange-100 bg-white p-1 gap-1">
            <button className="flex text-[12px] flex-1 items-center justify-center gap-2 rounded-md border border-orange-200 py-1 font-bold text-[#F36B21] shadow-sm">
              <Phone size={12} strokeWidth={2.5} /> Call Us
            </button>
            <button className="flex flex-1 items-center justify-center gap-1 rounded-md border border-green-200 py-1 font-bold text-[#16a34a] shadow-sm text-[12px]">
              <svg viewBox="0 0 24 24" className="h-3 w-3 text-[#16a34a]" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/></svg> WhatsApp Us
            </button>
          </div>
        </div>
      </div>
