...
import BecomeCoachModal from './BecomeCoachModal';
    ...
    <div className="flex flex-col gap-3">
      ...
      {links.map((link, index) => (
        <div
          ...
          className="cursor-pointer font-[Inter] text-xs text-gray-600 transition-colors hover:text-black md:text-sm"
        >
          {link.name}
        </div>
      ))}
  ...
  return (
    <footer style={style} className="w-full bg-[#F4F4F2] px-6 py-10 md:px-10">
      ...
      <div className="top-row flex w-full flex-col items-start justify-between md:flex-row">
        <div className="flex w-full flex-col items-start justify-between pb-8 md:flex-row md:items-center">
          <div className="md:w-1/2">
            <div className="my-5 inline-flex items-center rounded-full bg-black px-2 py-1 md:mt-0 md:hidden">
              <a
          ...
          {/* App store buttons */}
          <div className="mt-5 hidden items-center rounded-full bg-black px-2 py-1 md:mt-0 md:inline-flex">
            <a
              href="https://apps.apple.com/in/app/mytwin-parents-diabetes-care/id6763519090"
              className="flex shrink-0 items-center gap-2 whitespace-nowrap px-2 py-1 text-white"
            >
      ...
      <div className="space-y-3 font-[Inter] md:hidden">
        <span className="font-[Inter] text-sm font-bold text-black">Contact us</span>
        {/* Address */}
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-3 font-[Inter]">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600 transition-colors hover:text-orange-600 sm:text-sm">
                  <a href="tel:+918369255417">+91 8369255417</a>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600 sm:text-sm">
                  Plot 230,Ghansoli, Navi Mumbai,400701
                </p>
              </div>
            </div>
        ...
        <LinkList heading="Legal Links" links={terms} />
      </div>
      ...
      <BecomeCoachModal showModal={coachModal} handleCloseModal={() => setCoachModal(false)} />
    </footer>
  );
}
