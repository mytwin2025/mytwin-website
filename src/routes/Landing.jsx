...
export default function LandingPage() {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <PeopleBehindSection />
      <FAQSection />
      <div className="relative flex w-full flex-col items-center justify-center bg-[#fb741d] py-20">
        ...
        <div className="z-10 flex flex-col items-center justify-between pb-8">
          <h2 className="text-center font-[Arima] text-[63px] leading-tight text-white">
            Take Control of
          </h2>
          <div className="flex items-center justify-center">
            <h2 className="text-center font-[Arima] text-[63px] leading-tight text-white">Your</h2>
            <img
          ...
          <p className="mt-4 max-w-2xl text-center text-lg text-white text-[14px] leading-[28px] font-[Inter]">
          ...
          <button className="mt-8 rounded-full bg-white px-6 py-3 text-lg font-semibold text-[#2F387F] transition-colors hover:bg-gray-200 border-2 border-[#ffffff40] hover:border-[#ffffffcc] font-[Inter]">
