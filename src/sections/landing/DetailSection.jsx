...
\nnaturally and Support \nlong-term heart health \nwithout medications.`,
    ...
    },
    {
      index: '05',
      title: `Cholestrol \nManagement`,
      paragraph: `Lower bad Cholestrol (LDL) and boost \ngood Cholestrol (HDL) to support heart \nhealth naturally.`,
      variant: 'horizontal',
      buttonColor: '#166A74',
      image: Media.detailSection.cholesterolBg,
      icon: Media.heartRate2Icon,
      bgColor: '#F5F9F8',
    },
    {
      ...
      <div ref={contentRef} className="flex w-full flex-col items-center justify-center">
        ...
        <div id={'image-container'} className="relative flex w-full items-start justify-center">
          <GradientArcAnim
            ...
            color2="#ffffff"
            strokeWidth={1}
            style={{ backgroundColor: '', transform: 'translateY(-15%)' }}
          />
          <img
            src={Media.family}
